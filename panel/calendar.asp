        ...
        <div class="span9">
		  <div class="row-fluid">
			<div class="page-header">
				<h1>炎黄校历<small>查看或者修改当前校历</small></h1>
			</div>
            <img src="../../images/service/xiaoli.jpg" alt="" width="600" height="787"/>
			<form method="post" encType="multipart/form-data" action="actions/uploadcalendar.asp"  onsubmit="setFormSubmitting()">
            <label>
            上传校历：
            ...
            <input type="submit" class="btn btn-success btn-large" value="上传"/>
                ...
                <div class="ui-widget">
                    <div class="ui-state-highlight ui-corner-all" style="width:450px;margin-top: 20px;">
                        ...
                        <strong>注意：</strong> 图片必须是jpg，建议大小是600x787，或者请把图片做成类似的比例。 </p>
                    </div>
                </div>
            </form>
		  </div>
