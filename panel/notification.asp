      ...
      <div class="row-fluid">
        ...
        <div class="span9">
		  <div class="row-fluid">
                ...
                if not rs.EOF or not rs.BOF then
                    ...
                    Select Case Request("action")
	                    ...
	                    case "prev"
		                    ...
		                    if intpage < 1 or intpage > intPageCount then intpage = 1 end if
	                    case "next"
		                    intpage = Request("last")+1
		                    if intpage < 1 or intpage > intPageCount then intpage = intPageCount end if
	                    Case "last"
		                    intpage = intPageCount
	                    case else
		                    intpage = 1
                    ...
                    For intRecord = 1 To rs.PageSize
                        response.Write("<tr class='list-notification'>")
			...
			<a href="new-notification.asp" class="btn btn-success">新建通知</a>
		  </div>
        </div>
      </div>
